            ...
            <Tabs defaultValue="basic" className="w-full">
              ...
              <TabsContent value="basic" className="space-y-4 pt-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-sm text-muted-foreground">Company Logo URL</label>
                    <Input
                  ...
                  <div>
                    <label className="text-sm text-muted-foreground">Hero Image URL</label>
                    <Input
                  ...
                  <div className="col-span-2">
                    <label className="text-sm text-muted-foreground">Product Screenshot URL</label>
                    <Input
