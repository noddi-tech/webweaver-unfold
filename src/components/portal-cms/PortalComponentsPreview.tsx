  ...
  return (
    <PortalCmsLayout title="Deck component preview" description="Quality gate for the investor-grade slide component library before renderer refactor.">
      <div className="space-y-10">
        ...
        <ComponentPair name="AnnotatedChart" render={(density) => <AnnotatedChart density={density} title="Illustrative ARR glide path" valueLabel="ARR NOK M" points={samples.chartPoints} annotations={[{ label: "Commercial proof", description: "Hurtigruta Carglass validates repeatable operator value.", pointLabel: "Q3", align: "right" }, { label: "Round accelerates replication", description: "NOK 10–20M funds vertical expansion.", pointLabel: "Q5", align: "left" }]} />} />
