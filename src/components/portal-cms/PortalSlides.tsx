...
export function PortalSlideEditor() {
  ...
  return (
    <PortalCmsLayout title={isNew ? "New slide" : "Edit slide"} description="Preview renders directly from unsaved draft form values.">
      <div className={aiPanelActive ? "space-y-6" : "grid gap-6 lg:grid-cols-[minmax(0,3fr)_minmax(360px,2fr)]"}>
        <div className="space-y-6">
          <AiDraftPanel form={form} onAccept={acceptDraft} onActiveChange={setAiPanelActive} />
