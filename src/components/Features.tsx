    ...
    <section id="features" className="py-20 px-6 bg-background">
      <div className="container mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 gradient-text">Platform Benefits</h2>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Our comprehensive platform transforms how automotive maintenance providers operate, delivering efficiency, visibility, and growth.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {usingDb
            ? dbFeatures!.map((f) => {
                ...
                return (
                  <div key={f.id} className="bg-card rounded-xl p-6 hover:scale-105 transition-transform duration-300 border border-border shadow-sm">
            ...
            : defaultFeatures.map((feature, index) => (
                <div key={index} className="bg-card rounded-xl p-6 hover:scale-105 transition-transform duration-300 border border-border shadow-sm">
