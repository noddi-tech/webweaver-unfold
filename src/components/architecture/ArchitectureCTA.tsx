          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button size="lg" className="text-lg px-8 py-6 group" asChild>
              <LanguageLink to="/contact">
                <EditableTranslation translationKey="architecture.cta.button_demo">
                  <span>{t('architecture.cta.button_demo', 'Book a technical demo')}</span>
                </EditableTranslation>
            ...
            <Button size="lg" variant="outline" className="text-lg px-8 py-6" asChild>
              <LanguageLink to="/contact">
                ...
                <EditableTranslation translationKey="architecture.cta.button_docs">
                  <span>{t('architecture.cta.button_docs', 'Request docs')}</span>
                </EditableTranslation>
              </LanguageLink>
            </Button>
          </div>
