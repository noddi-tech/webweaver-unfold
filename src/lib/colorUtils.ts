...
export const getColorTokenOptions = () => [
  ...
  { value: 'primary-foreground', label: 'Primary Foreground', description: 'Text on primary color' },
  { value: 'secondary', label: 'Secondary', description: 'Secondary brand color' },
  { value: 'secondary-foreground', label: 'Secondary Foreground', description: 'Text on secondary color' },
  { value: 'card-foreground', label: 'Card Foreground', description: 'Text on card backgrounds' },
  { value: 'accent', label: 'Accent', description: 'Accent color' },
  { value: 'destructive', label: 'Destructive', description: 'Error/warning color' },
  { value: 'white', label: 'White', description: 'Pure white' },
